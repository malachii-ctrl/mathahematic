      ...
      <div className="container py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            ...
            <p className="text-gray-600 mb-4">Advanced mathematics learning platform for Caribbean students.</p>
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li>
                <Link href="/curriculum-guide" className="text-gray-600 hover:text-blue-600">
                  Curriculum Guide
                </Link>
              </li>
              <li>
                <Link href="/past-papers" className="text-gray-600 hover:text-blue-600">
                  Past Papers
                </Link>
              </li>
            </ul>
        ...
        <div className="mt-12 pt-8 border-t border-gray-200 flex flex-col md:flex-row justify-between items-center">
          <p className="text-sm text-gray-600">© 2025 EquaSolv.ai. All rights reserved.</p>
        </div>
      </div>
    </footer>
  )
